...
namespace LinkUp_REST_API.Services
{
    public class KeywordService : IKeywordService
    {
        ...
        public async Task<ResultDTO> CreateKeyword(KeywordCreateUpdateInput createDto, string userAccountId)
        {
            // null checks
        ...
        public Task<ResultDTO> DeleteKeywordById(Guid id, string userAccountId)
        {
            throw new NotImplementedException();
        }

        public Task<ResultDTO> UpdateKeyword(KeywordCreateUpdateInput updateDto, string userAccountId)
        {
            throw new NotImplementedException();
        }
    }
